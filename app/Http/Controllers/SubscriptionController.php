    ...
    public function dataTable(Auth $auth, $plan_id = null)
    {
        ...
        return app('datatables')->eloquent($model)
            ...
            ->addColumn('action', function (Subscription $item) {
                return implode([
                    Html::el('a', ["onclick"=>"hotLink('/savings/plan/".$item->id."', this)", "href"=>"savings/plan/".$item->id])->title(__('View Savings'))->setHtml(Html::el('i')->class('ri-eye-fill ri-2x text-primary'))
                ]);
            })
